...
public class PBRSadherTexture implements Shader {
    ...
    public void loadReflection(String refl, String type){
        ref=new Cubemap(Gdx.files.internal("cubemaps/" + refl + "_c00." + type), Gdx.files.internal("cubemaps/" + refl + "_c01." + type),
                Gdx.files.internal("cubemaps/" + refl + "_c02." + type), Gdx.files.internal("cubemaps/" + refl + "_c03." + type),
                Gdx.files.internal("cubemaps/" + refl + "_c04." + type), Gdx.files.internal("cubemaps/" + refl + "_c05." + type));
